 ...
 */
public final class IconFlipbook {
    ...
    public IconFlipbook(LostTalesUiSheet[] frames, LostTalesUiSheet[] hoverFrames) {
        this.frames = frames;
     ...
     */
    public void advance(boolean on, boolean lit) {
     ...
     * control.
     */
    public void draw(int boxLeft, int boxTop, int boxWidth, int boxHeight,
              int alpha) {
     ...
     */
    public void drawSettled(boolean on, int boxLeft, int boxTop, int boxWidth,
