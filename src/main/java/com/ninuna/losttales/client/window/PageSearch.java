 ...
 * search rule, asked of an entry instead of a message.</p>
 *
...
public final class PageSearch {
    ...
    public static final PageSearch NONE = new PageSearch("");

    private final List<String> words;

    private PageSearch(String raw) {
    ...
    public static PageSearch of(String raw) {
        PageSearch query = new PageSearch(raw);
