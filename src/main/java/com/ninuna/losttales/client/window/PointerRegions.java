...
/**
 * Rectangles of every overlay the window screen drew this frame — tabs,
 ...
 * windows.</p>
 */
public final class PointerRegions {
     ...
     */
    public void reset(int frameOffsetY) {
        this.count = 0;
     ...
     */
    public void add(int left, int top, int right, int bottom) {
    ...
    public void addScreen(int left, int top, int right, int bottom) {
     ...
     */
    public void addWindow(int left, int top, int right, int bottom) {
