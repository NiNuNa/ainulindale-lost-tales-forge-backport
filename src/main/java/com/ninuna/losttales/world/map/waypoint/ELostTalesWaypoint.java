...
public enum ELostTalesWaypoint {
    SUN_ELVES(LostTalesUtil.addWaypoint("SUN_ELVES", LOTRWaypoint.Region.RHUN, ELostTalesFaction.SUN_ELVES.getFaction(), 2504, 1514, true)),
    MOON_ELVES(LostTalesUtil.addWaypoint("MOON_ELVES", LOTRWaypoint.Region.FORODWAITH, ELostTalesFaction.MOON_ELVES.getFaction(), 1568, 535, true)),
    MOON_ELVES_2(LostTalesUtil.addWaypoint("MOON_ELVES_2", LOTRWaypoint.Region.FORODWAITH, ELostTalesFaction.MOON_ELVES.getFaction(), 1585, 531, true)),
