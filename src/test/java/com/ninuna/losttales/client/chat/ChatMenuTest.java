...
public final class ChatMenuTest {
    ...
    public void aMenuHangsBelowAControlInTheUpperHalfFromItsLeftEdge() {
        ...
        ChatMenu.Anchor anchor = ChatMenu.Anchor.inward(100, 20, 108, 30,
                0.0D, 0.0D, SCREEN_WIDTH, SCREEN_HEIGHT);
        LostTalesUiHitBox box = menu.firstContentBox(anchor, 80,
    ...
    public void aMenuTurnsRoundOnlyWhereTheOtherSideHoldsMoreOfIt() {
        ...
        ChatMenu.Anchor anchor = ChatMenu.Anchor.inward(100, 230, 108, 240,
                0.0D, 200.0D, SCREEN_WIDTH, 400.0D);
        LostTalesUiHitBox box = menu.firstContentBox(anchor, 80,
                SCREEN_WIDTH, SCREEN_HEIGHT);
    ...
    @Test
    public void aWordIsTakenBackToWhereItStarted() {
        assertEquals(6, ChatMenu.wordStart("hello world"));
        assertEquals(6, ChatMenu.wordStart("hello world  "));
        assertEquals(0, ChatMenu.wordStart("hello"));
        assertEquals(0, ChatMenu.wordStart(""));
    }
